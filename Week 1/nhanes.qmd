...
df %>% 
  tabyl(DIQ010) %>% # gets the number of types in a particular column
...
```{r}
(prior_probabillity_someone_has_diabetes * liklihood_someone_eats_tuna_has_diabetes_part_2) / prior_probabillity_someone_eats_tuna
```
