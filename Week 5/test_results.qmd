...
If there's two positive results, the Bayes theorem goes from 9% to 91%. This shows that repeated independent evidence significantly increases the diagnosis. The two positive results by different "labs" or test are unlikely to just be chance, but you can notice that probability is still not as high as the accuracy, the reported accuracy of the test.
